...
{
	[System.Serializable]
	public class LevelStartGameState : IState<GameState>
	{
		private const GameState STATE_TYPE = GameState.LevelStart;
		...
		public LevelStartGameState(GameController handler)
		{
